...
import 'package:golosinda_advmobprog/screens/detail_article_screen.dart';
import 'package:golosinda_advmobprog/widgets/add_article_form.dart';
...
class _ArticleScreenState extends State<ArticleScreen> {
  ...
  void _openAddArticleDialog() async {
        ...
        return AlertDialog(
          ...
          content: AddArticleForm(
            onArticleAdded: (article) {
              setState(() {
                _allArticles.insert(0, article); // Add the new article at the top
                _onSearchChanged();
              });
            },
          ),
